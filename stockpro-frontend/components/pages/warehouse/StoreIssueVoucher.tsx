...
const StoreIssueVoucher: React.FC<StoreIssueVoucherProps> = ({
  ...
  const { data: vouchers = [], isLoading: isLoadingVouchers } = useGetStoreIssueVouchersQuery();
  const [createVoucher, { isLoading: isCreating }] = useCreateStoreIssueVoucherMutation();
  const [updateVoucher, { isLoading: isUpdating }] = useUpdateStoreIssueVoucherMutation();
  const [deleteVoucher, { isLoading: isDeleting }] = useDeleteStoreIssueVoucherMutation();
