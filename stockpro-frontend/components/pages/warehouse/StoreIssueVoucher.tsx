...
import type { CompanyInfo, StoreVoucherItem, Branch, StoreIssueVoucher as StoreIssueVoucherType } from '../../../types';
...
const StoreIssueVoucher: React.FC<StoreIssueVoucherProps> = ({ title, companyInfo, items: allItems, branches, vouchers, onSave, onDelete }) => {
    ...
    const tableInputStyle = "text-center bg-transparent focus:outline-none focus:ring-1 focus:ring-brand-green rounded p-1 w-full disabled:bg-transparent";
                    ...
                    <table className="min-w-full">
                        ...
                        <tbody ref={itemSearchRef}>
                            {items.map((item, index) => (
                                 <tr key={index} className="divide-x divide-gray-200 border-b border-gray-200 last:border-b-0 hover:bg-brand-green-bg transition-colors duration-150">
