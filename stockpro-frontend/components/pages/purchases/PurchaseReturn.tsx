...
import { PdfIcon, ListIcon, PrintIcon, SearchIcon, TrashIcon } from '../../icons';
import { tafqeet } from '../../../utils/tafqeet';
// FIX: Add User to type import
import type { CompanyInfo, InvoiceItem, Supplier, Invoice, User, Safe, Bank } from '../../../types';
import PurchaseInvoicePrintPreview from './PurchaseInvoicePrintPreview';
import { useModal } from '../../common/ModalProvider';
import { useToast } from '../../common/ToastProvider';

type SelectableItem = {id: string, name: string, unit: string, price: number, stock: number};
...
const PurchaseReturn: React.FC<PurchaseReturnProps> = ({ title, vatRate, isVatEnabled, companyInfo, items: allItems, suppliers: allSuppliers, invoices, onSave, onDelete, currentUser, viewingId, onClearViewingId, safes, banks }) => {
    ...
    const handleNew = () => {
        ...
        setInvoiceDetails({
            invoiceNumber: `PRTN-${Math.floor(10000 + Math.random() * 90000)}`,
        ...
        <>
            <div className="bg-white p-6 rounded-lg shadow">
                ...
                <div className="border-2 border-brand-green rounded-lg">
                    <div className="p-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                            ...
                            <input type="text" placeholder="رقم المرتجع" className={inputStyle} value={invoiceDetails.invoiceNumber} onChange={e => setInvoiceDetails({...invoiceDetails, invoiceNumber: e.target.value})} readOnly={currentIndex > -1 || isReadOnly} />
                ...
                <div className="overflow-x-auto my-4 border-2 border-brand-green rounded-lg">
                 ...
                 <button onClick={handleAddItem} className="mb-4 px-4 py-2 bg-gray-200 text-brand-dark rounded-md hover:bg-gray-300 font-semibold disabled:bg-gray-300 disabled:cursor-not-allowed" disabled={isReadOnly}>اضافة سطر</button>
