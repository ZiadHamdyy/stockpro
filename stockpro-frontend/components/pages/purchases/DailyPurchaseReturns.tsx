...
const DailyPurchaseReturns: React.FC<DailyPurchaseReturnsProps> = ({ title, companyInfo, purchaseReturns }) => {
    ...
    const totals = filteredReturns.reduce((acc, purchase) => {
    ...
    const handlePdfExport = () => {
        const head = [['صافي المبلغ', 'الخصم', 'الضريبة', 'المبلغ', 'المورد', 'رقم المرتجع', 'التاريخ', 'م']];
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-brand-green">
                        <tr>
                            ...
                            <th className="px-6 py-3 text-right text-sm font-semibold text-white uppercase tracking-wider">رقم المرتجع</th>
