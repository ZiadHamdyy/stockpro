...
const InvoicePrintPreview: React.FC<InvoicePrintPreviewProps> = ({ isOpen, onClose, invoiceData }) => {
    if (!isOpen) return null;

    const { companyInfo, vatRate, isVatEnabled, items, totals, paymentMethod, customer, details } = invoiceData;
                    ...
                    <div id="printable-invoice" className="p-8 bg-white">
                        <header className="flex justify-between items-start pb-4 border-b-2 border-brand-blue">
                            ...
                            <div className="text-left">
                                <h1 className="text-3xl font-bold text-brand-blue">فاتورة ضريبية</h1>
                                <p>Tax Invoice</p>
                            </div>
                        </header>
                        ...
                        <section className="grid grid-cols-2 gap-x-8 text-sm my-6">
                            <div className="border border-gray-300 rounded-md p-3">
                                ...
                                <p><span className="font-semibold">الاسم:</span> {customer?.name || 'عميل نقدي'}</p>
                        ...
                        <table className="w-full text-sm border-collapse border border-gray-300">
                            <thead className="bg-brand-blue text-white">
                                <tr>
                                    ...
                                    {isVatEnabled && <th className="p-2 border border-blue-300">مبلغ الضريبة</th>}
