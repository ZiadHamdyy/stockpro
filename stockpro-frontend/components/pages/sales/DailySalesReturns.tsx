...
const DailySalesReturns: React.FC<DailySalesReturnsProps> = ({ title, companyInfo, salesReturns }) => {
    ...
    const totals = filteredReturns.reduce((acc, sale) => {
    ...
    const handlePdfExport = () => {
        const head = [['صافي المبلغ', 'الخصم', 'الضريبة', 'المبلغ', 'العميل', 'رقم المرتجع', 'التاريخ', 'م']];
