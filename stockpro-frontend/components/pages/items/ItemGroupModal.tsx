...
import {
  addItemGroup,
  updateItemGroup as updateItemGroupAction,
...
const ItemGroupModal: React.FC<ItemGroupModalProps> = ({
  ...
  const [createItemGroup, { isLoading: createLoading }] =
    useCreateItemGroupMutation();
  const [updateItemGroup, { isLoading: updateLoading }] =
    useUpdateItemGroupMutation();
      ...
      >
        <div className="p-4 border-b border-gray-200">
          <h2 className="text-xl font-bold text-brand-dark">
            {groupToEdit ? "تعديل مجموعة" : "اضافة مجموعة جديدة"}
          </h2>
        </div>
