...
interface InternalTransferPrintPreviewProps {
  isOpen: boolean;
  onClose: () => void;
  voucherData: {
    number: string;
...
const InternalTransferPrintPreview: React.FC<InternalTransferPrintPreviewProps> = ({
  isOpen,
  onClose,
  voucherData,
}) => {
      ...
      >
        <div className="p-4 border-b flex justify-between items-center print:hidden bg-gray-50 rounded-t-lg">
          <h2 className="text-xl font-bold text-brand-dark">
            معاينة طباعة سند التحويل البيني
          </h2>
          <div className="flex items-center gap-2">
            <button
              onClick={handlePrint}
              className="px-4 py-2 bg-amber-500 text-white rounded-md hover:bg-amber-600 font-semibold flex items-center"
            >
        ...
        <div className="overflow-y-auto flex justify-center">
          ...
          >
            <div className="border-2 border-amber-500 h-full p-4 flex flex-col justify-between rounded-lg">
              <div className="flex justify-between items-center pb-2 border-b-2 border-amber-500">
              ...
              <main className="flex-grow my-4 space-y-3 text-base">
                <div className="flex items-center pt-4">
                  ...
                  <span className="border-b-2 border-dotted border-gray-400 flex-grow px-2">
                    {fromAccount} ({fromType === "safe" ? "خزنة" : "بنك"})
                  </span>
                </div>
                <div className="flex items-center">
                  <label className="font-bold w-48">إلى:</label>
                  <span className="border-b-2 border-dotted border-gray-400 flex-grow px-2">
                    {toAccount} ({toType === "safe" ? "خزنة" : "بنك"})
                  </span>
                </div>
                <div className="flex items-center">
                  <label className="font-bold w-48">مبلغ وقدره:</label>
                  <span className="border-b-2 border-dotted border-gray-400 flex-grow px-2 font-mono font-bold bg-yellow-100 text-amber-600 text-lg">
                ...
                <div className="flex items-center">
                  <label className="font-bold w-48">ملاحظات:</label>
                  <span className="border-b-2 border-dotted border-gray-400 flex-grow px-2">
              ...
              <footer className="flex justify-around items-end pt-2 border-t-2 border-amber-500 text-center text-sm">
                <div>
...
export default InternalTransferPrintPreview;
