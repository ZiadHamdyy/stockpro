...
const CurrentAccountsList: React.FC<CurrentAccountsListProps> = ({ title, accounts, onAddNew, onEdit, onDelete }) => {
        ...
        <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="flex justify-between items-center mb-4 no-print">
                <div className="relative">
                    ...
                    <input type="text" placeholder="بحث عن حساب..." className={inputStyle} />
                </div>
                        ...
                        {accounts.map((account) => (
                            <tr key={account.id} className="hover:bg-brand-blue-bg">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium no-print">
                                    <button onClick={() => onEdit(account.id)} className="text-brand-blue hover:text-blue-800 font-semibold ml-4">تعديل</button>
