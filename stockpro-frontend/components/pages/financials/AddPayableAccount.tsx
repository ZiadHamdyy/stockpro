      ...
      <form onSubmit={(e) => { e.preventDefault(); handleSave(); }} className="space-y-4">
        ...
        <div className="mt-8 pt-6 border-t-2 border-gray-200 flex flex-col items-start space-y-4">
          <div className="flex justify-start gap-2">
            <PermissionWrapper requiredPermission={buildPermission(Resources.PAYABLE_ACCOUNTS, Actions.CREATE)}>
            ...
            <PermissionWrapper requiredPermission={buildPermission(Resources.PAYABLE_ACCOUNTS, Actions.DELETE)}>
