    ...
    <>
      ...
      <div className="flex justify-between items-center mb-4 no-print">
        ...
        <div className="flex items-center gap-2">
          <PermissionWrapper requiredPermission={buildPermission(Resources.PAYABLE_ACCOUNTS, Actions.PRINT)} fallback={<button disabled title="تصدير Excel" className="p-3 border-2 border-gray-200 rounded-md cursor-not-allowed opacity-50"><ExcelIcon className="w-6 h-6" /></button>}>
          ...
          <PermissionWrapper requiredPermission={buildPermission(Resources.PAYABLE_ACCOUNTS, Actions.PRINT)} fallback={<button disabled title="تصدير PDF" className="p-3 border-2 border-gray-200 rounded-md cursor-not-allowed opacity-50"><PdfIcon className="w-6 h-6" /></button>}>
          ...
          <PermissionWrapper requiredPermission={buildPermission(Resources.PAYABLE_ACCOUNTS, Actions.PRINT)} fallback={<button disabled title="طباعة" className="p-3 border-2 border-gray-200 rounded-md cursor-not-allowed opacity-50"><PrintIcon className="w-6 h-6" /></button>}>
