    ...
    const handleExcelExport = () => {
        const dataToExport = [
            ...
            ...reportData.map((item) => ({
                ...
                المرجع: item.ref || "",
                "ضريبة المبيعات": item.type === 'credit' ? formatNumber(item.tax) : "",
                "ضريبة المشتريات": item.type === 'debit' ? formatNumber(item.tax) : "",
            ...
            })),
            {
                ...
                البيان: "",
                المرجع: "",
                "ضريبة المبيعات": formatNumber(totalCredit),
                "ضريبة المشتريات": formatNumber(totalDebit),
                الرصيد: formatNumber(netTax),
            },
        ];
        exportToExcel(dataToExport, "كشف_ضريبة_القيمة_المضافة");
    };
