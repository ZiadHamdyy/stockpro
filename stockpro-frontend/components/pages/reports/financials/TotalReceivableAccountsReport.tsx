...
const TotalReceivableAccountsReport: React.FC<TotalReceivableAccountsReportProps> = ({
  title,
  companyInfo,
  currentUser,
  ...
  const handleExcelExport = () => {
    ...
    exportToExcel(dataToExport, "تقرير_إجمالي_الحسابات_المدينة");
  };
        ...
        <div className="flex justify-between items-center my-4 bg-gray-50 p-3 rounded-md border-2 border-gray-200 no-print">
          ...
          <PermissionWrapper
            requiredPermission={buildPermission(
              Resources.TOTAL_RECEIVABLE_ACCOUNTS_REPORT,
              Actions.PRINT,
            )}
            fallback={
...
export default TotalReceivableAccountsReport;
