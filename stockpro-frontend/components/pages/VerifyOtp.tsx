...
import { useVerifyForgotPasswordOtpMutation, useResendForgotPasswordOtpMutation } from '../store/slices/auth/authApi';
        ...
        <div className="min-h-screen flex items-center justify-center bg-brand-bg py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="flex justify-center space-x-2 space-x-reverse" dir="ltr">
                        {otp.map((digit, index) => (
                            <input
                                key={index}
