...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({ title, message, onConfirm, onCancel, type, showPassword }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center p-4" onClick={onCancel}>
            <div className={`bg-white rounded-lg shadow-xl w-full max-w-md ${selectedTheme.bg}`} onClick={(e) => e.stopPropagation()}>
                <div className="p-6 text-center">
                    <h2 className={`text-2xl font-bold mb-4 ${selectedTheme.title}`}>{title}</h2>
