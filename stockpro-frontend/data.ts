...
export const initialItems: Item[] = [
  ...
  },
  {
    id: 4,
    code: "301",
    barcode: "0718103283754",
    name: "ورق طباعة A4",
    group: "مستلزمات مكتبية",
    unit: "رزمه",
    purchasePrice: 20,
    salePrice: 25,
    stock: 1000,
...
export const initialExpenses: Expense[] = [
  {
    ...
    date: "2024-07-01",
    expenseCodeId: 1,
    expenseCode: "EXP-ADM-01",
    expenseCodeName: "رواتب وأجور",
    expenseCodeType: "مصاريف إدارية",
    amount: 25000,
  ...
  },
  {
    ...
    date: "2024-07-05",
    expenseCodeId: 2,
    expenseCode: "EXP-GEN-01",
    expenseCodeName: "إيجارات",
    expenseCodeType: "مصاريف عمومية",
    amount: 10000,
  ...
  },
  {
    ...
    date: "2024-07-10",
    expenseCodeId: 3,
    expenseCode: "EXP-GEN-02",
    expenseCodeName: "كهرباء ومياه",
    expenseCodeType: "مصاريف عمومية",
    amount: 1500,
...
export const initialPurchaseReturns: Invoice[] = [
  {
    ...
    customerOrSupplier: { id: "1", name: "المورد الأول" },
    items: [],
    totals: { subtotal: 350, discount: 0, tax: 52.5, net: 402.5 },
    paymentMethod: "credit",
    paymentTerms: 30,
    userName: "مدير النظام",
    branchName: "الفرع الرئيسي",
...
export const initialReceiptVouchers: Voucher[] = [
  {
    ...
    type: "receipt",
    date: "2024-05-15",
    entity: { type: "customer", id: 1, name: "العميل الأول" },
    amount: 5000,
    description: "دفعة من حساب فاتورة INV-00123",
    paymentMethod: "safe",
    safeOrBankId: 1,
    userName: "مدير النظام",
    branchName: "الفرع الرئيسي",
  },
  {
    ...
    type: "receipt",
    date: "2024-05-15",
    entity: { type: "current_account", id: 2, name: "جاري الشريك ب" },
    amount: 50000,
    description: "إيداع في الحساب الجاري",
    paymentMethod: "bank",
    safeOrBankId: 1,
    userName: "مدير النظام",
    branchName: "الفرع الرئيسي",
...
export const initialPaymentVouchers: Voucher[] = [
  {
    ...
    type: "payment",
    date: "2024-05-16",
    entity: { type: "supplier", id: 1, name: "المورد الأول" },
    amount: 8000,
    description: "دفعة من حساب فاتورة",
    paymentMethod: "safe",
    safeOrBankId: 1,
    userName: "مدير النظام",
    branchName: "الفرع الرئيسي",
  },
  {
    ...
    type: "payment",
    date: "2024-05-01",
    entity: { type: "current_account", id: 1, name: "جاري الشريك أ" },
    amount: 10000,
