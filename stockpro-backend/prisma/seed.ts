...
async function main() {
  ...
  const permissions = [
    ...
    },
    {
      ...
      action: 'view',
      description: 'View daily sales returns reports',
    },
    ...
    },
    {
      ...
      action: 'view',
      description: 'View daily purchases reports',
    },
    {
      resource: 'daily_purchase_returns',
      action: 'view',
      description: 'View daily purchase returns reports',
    },
    ...
    },
    {
      ...
      action: 'create',
      description: 'Create store receipt voucher',
    },
    {
      resource: 'store_receipt_voucher',
      action: 'read',
    ...
    },
    {
      ...
      action: 'create',
      description: 'Create store issue voucher',
    },
    {
      resource: 'store_issue_voucher',
      action: 'read',
    ...
    },
    {
      ...
      action: 'create',
      description: 'Create store transfer',
    },
    {
      resource: 'store_transfer',
      action: 'read',
    ...
    { resource: 'expenses', action: 'manage', description: 'Manage expenses' },
    {
      ...
      action: 'manage',
      description: 'Manage current accounts',
    },
